package com.linkage.module.cms.alarm.framework.view.menu.filter
{
	...
	public class ChainRule
	{
		 ...
		 *日志记录器
		 */
		private var log:ILogger = Log.getLogger("com.linkage.module.cms.alarm.framework.view.menu.filter.ChainRule");
		...
		public function ChainRule(rule:String)
		{
			if (rule == null)
			{
				throw new Error("规则异常，传入的规则不允许为空");
			}
			try
			{
			...
			{
				log.error("解析规则出错" + e.getStackTrace());
			}
		}
